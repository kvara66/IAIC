...
class DINOLoss(nn.Module):
    """
    1 - cosine_similarity of EVA-02-Base-448 image features.

    채점기는 vit_small_patch14_dinov2(518px)를 씀 — 동일 모델 사용 금지 규정으로
    EVA-02-Base(448px)로 대체. 500쌍 로컬 실험에서 Pearson r=0.668로 후보 중 최고.
    클래스명은 하위 호환 위해 유지.
    """
